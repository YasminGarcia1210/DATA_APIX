...
def download_insightface_models():
    """Configurar modelos de InsightFace"""
...
FACE_DETECTION_SIZE = (640, 640)  # Tamaño para detección facial
EMBEDDING_THRESHOLD = 0.4         # Umbral por defecto para verificación
...
def create_download_script():
    """Crear script para descargar CelebA"""
...
def download_celeba():
    ...
    # URLs de CelebA (ejemplo - usar URLs oficiales)
    files_to_download = {
...
def run_tests():
    ...
    try:
        # Test 1: Importar dependencias principales
...
def main():
    ...
    # Configurar modelos InsightFace
    if success and not download_insightface_models():
        success = False
    ...
    if success and not create_download_script():
        success = False
